                        ...
                        >
                             ...
                             <div className="flex items-center gap-3 sm:gap-4">
                                ...
                                <div className="flex flex-col items-center gap-1">
                                  <span className="material-icons text-xl sm:text-2xl text-blue-400">
                                    {day.rainChance > 50 ? 'water_drop' : day.condition.toLowerCase().includes('cloud') ? 'cloud' : 'wb_sunny'}
                                  </span>
