  ...
  return (
    <div className="bg-gray-100 dark:bg-[#0B0C15] min-h-screen flex justify-center font-sans transition-colors duration-300 md:p-8">
       ...
       >
          ...
          <div className="px-6 mb-6 max-w-2xl mx-auto w-full relative z-30">
          ...
          <main className="flex-1 overflow-y-auto px-6 pb-24 hide-scroll">
             <div className="flex items-center gap-6 mb-6 text-sm font-medium">
               <button
                  ...
                  className={cn("transition-colors pb-1", view === 'today' ? "text-gray-900 dark:text-white border-b-2 border-[#B2DAFF]" : "text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200")}
               >
                 Today
               </button>
               <button
                 ...
                 <div className="lg:col-span-1 space-y-8">
                    ...
                    <motion.div initial={{ y: 20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ delay: 0.4 }} className="space-y-4 mb-6">
                        <div className="flex justify-between items-center mb-2">
                            ...
                            <Link href="/cities" className="text-xs text-[#B2DAFF] font-medium hover:underline">Show All &gt;</Link>
                        </div>
                        ...
                        >
                            <div className="flex items-center gap-4">
                                <div className="bg-red-100 dark:bg-red-500/20 p-2 rounded-2xl w-10 h-10 flex items-center justify-center">
                                    <span className="text-xl">🇮🇩</span>
                                </div>
                                <div>
                                    <p className="text-xs text-gray-400 mb-0.5">Indonesia</p>
                                    <h4 className="font-semibold dark:text-white">Bandung</h4>
                                    <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Rainy</p>
                                </div>
                            </div>
                            <div className="text-right">
                                <span className="block text-2xl font-bold dark:text-white">24°</span>
                            </div>
                        </div>
                    </motion.div>

                    {/* Air Quality Button (Visible on Mobile/Tablet usually) */}
                    <motion.div initial={{ y: 20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ delay: 0.5 }}>
                        <Link href="/details/air-quality" className="bg-[#1E1F29] dark:bg-white text-white dark:text-black rounded-3xl p-6 flex items-center justify-between shadow-lg hover:shadow-xl transition-shadow group">
                           <div className="flex items-center gap-4">
                              <span className="material-icons text-3xl group-hover:rotate-180 transition-transform duration-500">air</span>
                              <div>
                                 <h3 className="font-bold text-lg">Air Quality</h3>
                                 <p className="text-xs opacity-70">Check AQI Near You</p>
                              </div>
                           </div>
